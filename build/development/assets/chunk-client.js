import { c as getDefaultExportFromCjs } from "./chunk-constants.js";
...
const ApiKeyForm = ({ handleApiKeySubmit, isError, errorMsg, isPopUp }) => {
  ...
  const apiKeyInputRef = reactExports.useRef(null);
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "ah-api-enter_api_key", children: /* @__PURE__ */ jsxs("h6", { children: [
      "Enter an API key",
      isPopUp ? " to activate extension" : "",
      ":"
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "ah-api-input-status", children: [
      /* @__PURE__ */ jsx(RenderIf, { isTrue: isError, children: /* @__PURE__ */ jsx("div", { className: "status error", children: /* @__PURE__ */ jsxs("span", { children: [
        /* @__PURE__ */ jsx("img", { src: chrome.runtime.getURL(exclamationCircleSVG), style: { marginRight: 4 } }),
        errorMsg
      ] }) }) }),
      /* @__PURE__ */ jsx("div", { className: "ah-api-enter_api_key", children: /* @__PURE__ */ jsx("input", { ref: apiKeyInputRef, placeholder: "API Key Here", className: "ah-api-input-control", id: "api_key" }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "ah-api-enter_api_key", "data-action": "api_key_submit", children: /* @__PURE__ */ jsx(
      "button",
      {
        ...
        children: "Activate Extension"
      }
    ) }),
    /* @__PURE__ */ jsxs("span", { className: "ah-api-footer-button ah-api-enter_api_key", children: [
      isPopUp ? "Don’t have an API key? " : "",
      /* @__PURE__ */ jsx("a", { href: "https://arbitragehero.com", target: "_blank", rel: "noreferrer", children: "Click here to get one." })
    ] })
  ] });
};
const CrossAPIForm = ({ setIsFormOpen }) => {
  return /* @__PURE__ */ jsx("div", { className: "box-close", onClick: () => setIsFormOpen(false), children: /* @__PURE__ */ jsx("img", { src: chrome.runtime.getURL("/assets/icons/bx-cross.svg"), alt: "close" }) });
};
const Header = () => {
  const arbitrageLogo = "assets/images/arbitrageLogo.png";
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "ah-stores-header", children: /* @__PURE__ */ jsx("a", { href: "https://arbitragehero.com/", target: "_blank", rel: "noreferrer", children: /* @__PURE__ */ jsx("img", { src: chrome.runtime.getURL(arbitrageLogo), width: "70px" }) }) }) });
};
const NoInternet = () => {
  const noConnectionSVG = "./assets/icons/no-connection.svg";
  return /* @__PURE__ */ jsxs("div", { className: "ah-api-key-body", children: [
    /* @__PURE__ */ jsx("div", { id: "internet_image_connection_div", children: /* @__PURE__ */ jsx("img", { src: chrome.runtime.getURL(noConnectionSVG), width: "70px" }) }),
    /* @__PURE__ */ jsx("div", { id: "internet_connection_div", children: /* @__PURE__ */ jsx("h4", { children: "Please Check Your Internet Connection!" }) })
  ] });
};
const ValidApiKey = () => {
  const checkCircleSVG = "/assets/icons/CheckCircle.svg";
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "ah-api-input-status", children: /* @__PURE__ */ jsx("div", { className: "status success", children: /* @__PURE__ */ jsxs("span", { children: [
      /* @__PURE__ */ jsx("img", { src: chrome.runtime.getURL(checkCircleSVG), style: { marginRight: 4 } }),
      "Valid API key."
    ] }) }) }),
    /* @__PURE__ */ jsx("span", { className: "ah-api-footer-button", id: "footer-text", children: /* @__PURE__ */ jsx("a", { href: "https://arbitragehero.com", target: "_blank", rel: "noreferrer", children: "Click here to learn more" }) })
  ] });
};
const APIValidationMain = ({ isPopUp = true, setIsFormOpen, handleChangeLoginHeader }) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "ah-api-key-page", children: [
    /* @__PURE__ */ jsx(RenderIf, { isTrue: isPopUp, children: /* @__PURE__ */ jsx(Header, {}) }),
    /* @__PURE__ */ jsx(RenderIf, { isTrue: navigator.onLine, fallback: /* @__PURE__ */ jsx(NoInternet, {}), children: /* @__PURE__ */ jsx(
      RenderIf,
      {
        isTrue: !loader,
        fallback: /* @__PURE__ */ jsx("div", { className: "ah-api-key-body", children: /* @__PURE__ */ jsx("div", { className: "ah-loader_main", children: /* @__PURE__ */ jsx("div", { className: "ah-loader" }) }) }),
        children: /* @__PURE__ */ jsxs("div", { className: "ah-api-key-body", children: [
          /* @__PURE__ */ jsx(RenderIf, { isTrue: !isPopUp, children: /* @__PURE__ */ jsx(CrossAPIForm, { setIsFormOpen }) }),
          /* @__PURE__ */ jsx(RenderIf, { isTrue: !(apiKeyResponse == null ? void 0 : apiKeyResponse.license), fallback: /* @__PURE__ */ jsx(ValidApiKey, {}), children: /* @__PURE__ */ jsx(ApiKeyForm, { handleApiKeySubmit, isPopUp, isError: errorMsg != null, errorMsg }) })
        ] })
      }
    ) })
  ] });
